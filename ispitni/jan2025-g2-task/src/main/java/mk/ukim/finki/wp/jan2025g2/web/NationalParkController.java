...
public class NationalParkController {
    ...
    public String listAll(@RequestParam(required = false) String name,
        ...
        Page<NationalPark> page = nationalParkService.findPage(name, areaSize, rating, parkType, locationId, pageNum, pageSize);
        model.addAttribute("page", page);
        model.addAttribute("name", name);
        model.addAttribute("areaSize", areaSize);
        model.addAttribute("rating", rating);
        model.addAttribute("parkType", parkType);
        model.addAttribute("location", parkLocationService.findById(locationId));
